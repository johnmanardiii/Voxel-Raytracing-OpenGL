...
layout(location = 2, r32ui) uniform uimage3D voxoutput_red;
layout(location = 3, r32ui) uniform uimage3D voxoutput_green;
layout(location = 4, r32ui) uniform uimage3D voxoutput_blue;
layout(location = 5, r32ui) uniform uimage3D voxoutput_alpha;
